...
class RemoveOldManualUserPagesTest extends MediaWikiTestCase {
	...
	public static function provideNormalizeUserName() {
		return [
			[ 'UserName', 'UserName', 'A regular name with no fancy things' ],
			[ 'John F. Lewis', 'John( |_|\+|%20)F\.( |_|\+|%20)Lewis', 'A name with spaces and a period' ],
			[ 'Jdforrester (WMF)', 'Jdforrester( |_|\+|%20)\(WMF\)', 'A name with spaces and parenthesis' ],
			[ 'संतोष दहिवळ', 'संतोष( |_|\+|%20)दहिवळ', 'A name with spaces and unicode' ],
		];
	}
